...
// Reject application
export const rejectApplication = async (id, reason, adminId) => {
    const updateData = {
        status: "rejected",
...
// Request more info
export const requestMoreInfo = async (id, message, adminId) => {
    const updateData = {
        status: "more_info",
...
export const getAllMerchants = async () => repo.getAllMerchants();
// Suspend merchant
export const suspendMerchant = async (id, reason, adminId) => {
    const updateData = {
        status: "suspended",
    };
...
// Update commission tier
export const updateCommissionTier = async (id, tier, adminId) => {
...
//# sourceMappingURL=merchant_service.js.map